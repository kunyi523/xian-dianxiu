...
export const MOUNTAIN_PATHS: { nx: number; ny: number }[][] = [
  ...
  // 1 · 右山环 — 雷音塔 0.753/0.24 → 镇岳碑 0.857/0.256 → 观劫台 0.99/0.42 → 葬剑崖 0.978/0.533 → 潜龙渊 0.902/0.793
  [
    { nx: 0.66, ny: 0.32 },
    { nx: 0.753, ny: 0.38 },
    { nx: 0.82, ny: 0.38 },
  ...
  // 2 · 中央朝圣 — 香案 0.619/0.505 直上劫云 0.619/0.12
  [
    { nx: 0.619, ny: 0.33 },
    { nx: 0.619, ny: 0.26 },
    { nx: 0.619, ny: 0.18 },
...
export const TRIB = { nx: 0.619, ny: 0.12 };
