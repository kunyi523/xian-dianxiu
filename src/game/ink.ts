...
export const PEAKS: Peak[] = [
  ...
  // 右上孤峰 → 雷骨塔(真融合:块 2986,393,450,450)
  { id: "tower", nx: 0.968, ny: 0.233, hw: 0.0375, hh: 0.048, band: 0, z: 1 },
  // 右中峰 → 望劫镜(真融合:块 2772,799,450,450)
  { id: "mirror", nx: 0.912, ny: 0.595, hw: 0.0465, hh: 0.036, band: 0, z: 2 },
  // 左山腰 → 瀑侧丹灶(真融合:块 1214,838,450,450)
  { id: "alchemy", nx: 0.266, ny: 0.647, hw: 0.0375, hh: 0.033, band: 1, z: 0 },
  // 左中山腰台地 → 镇峰残纹(真融合:块 1662,722,450,450)
  { id: "array", nx: 0.406, ny: 0.44, hw: 0.054, hh: 0.038, band: 1, z: 1 },
  // 右山腰 → 龙脉口（洞府入口）(真融合:块 3029,1205,450,450)
  { id: "mine", nx: 0.945, ny: 0.828, hw: 0.0405, hh: 0.038, band: 1, z: 2 },
  // 左近山丘 → 云阶茅舍(真融合:块 1086,1282,450,450)
  { id: "house", nx: 0.132, ny: 0.854, hw: 0.054, hh: 0.033, band: 2, z: 0 },
  // 中央主建筑 → 开山香案（瀑布上方）(真融合:块 2163,782,600,600)
  { id: "hall", nx: 0.664, ny: 0.595, hw: 0.063, hh: 0.046, band: 2, z: 1 },
  // 右近山丘 → 悬剑冢(真融合:块 2452,1340,450,450)
  { id: "sword", nx: 0.406, ny: 0.818, hw: 0.0435, hh: 0.04, band: 2, z: 2 },
];
...
/** 拜山多径：世界坐标(nx 0-1 铺满 worldW)；左山环 / 右山环 / 中央朝圣(跟新背景建筑位) */
export const MOUNTAIN_PATHS: { nx: number; ny: number }[][] = [
  // 0 · 左山环 — 听松庐 0.132/0.854 → 丹鼎阁 0.266/0.647 → 镇岳碑 0.406/0.44 → 葬剑崖 0.406/0.818
  [
    { nx: 0.24, ny: 0.9 },
    { nx: 0.32, ny: 0.82 },
    { nx: 0.38, ny: 0.68 },
  ...
  // 1 · 右山环 — 雷音塔 0.968/0.233 → 观劫台 0.912/0.595 → 潜龙渊 0.945/0.828
  [
    { nx: 0.84, ny: 0.18 },
    { nx: 0.968, ny: 0.1 },
    { nx: 0.84, ny: 0.28 },
  ...
  // 2 · 中央朝圣 — 香案 0.664/0.595 直上劫云 0.664/0.12
  [
    { nx: 0.664, ny: 0.48 },
    { nx: 0.664, ny: 0.36 },
    { nx: 0.664, ny: 0.24 },
...
export const TRIB = { nx: 0.664, ny: 0.12 };
