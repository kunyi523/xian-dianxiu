...
export const PEAKS: Peak[] = [
  ...
  { id: "tower", nx: 0.95, ny: 0.32, hw: 0.0375, hh: 0.048, band: 0, z: 1 },
  // 右中峰 → 望劫镜(真融合:块 2772,799,450,450)
  { id: "mirror", nx: 0.85, ny: 0.53, hw: 0.0465, hh: 0.036, band: 0, z: 2 },
  // 左山腰 → 瀑侧丹灶(真融合:块 1214,838,450,450)
  { id: "alchemy", nx: 0.12, ny: 0.55, hw: 0.0375, hh: 0.033, band: 1, z: 0 },
  // 左中山腰台地 → 镇峰残纹(真融合:块 1662,722,450,450)
  { id: "array", nx: 0.33, ny: 0.49, hw: 0.054, hh: 0.038, band: 1, z: 1 },
  // 右山腰 → 龙脉口（洞府入口）(真融合:块 3029,1205,450,450)
  { id: "mine", nx: 0.97, ny: 0.74, hw: 0.0405, hh: 0.038, band: 1, z: 2 },
  // 左近山丘 → 云阶茅舍(真融合:块 1086,1282,450,450)
  { id: "house", nx: 0.06, ny: 0.78, hw: 0.054, hh: 0.033, band: 2, z: 0 },
  // 中央主建筑 → 开山香案（瀑布上方）(真融合:块 2163,782,600,600)
  { id: "hall", nx: 0.6, ny: 0.56, hw: 0.063, hh: 0.046, band: 2, z: 1 },
  // 右近山丘 → 悬剑冢(真融合:块 2452,1340,450,450)
  { id: "sword", nx: 0.7, ny: 0.81, hw: 0.0435, hh: 0.04, band: 2, z: 2 },
];
...
export const MOUNTAIN_PATHS: { nx: number; ny: number }[][] = [
  ...
  // 2 · 中央朝圣 — 香案 0.60/0.56 直上劫云 0.60/0.12
  [
    { nx: 0.6, ny: 0.565 },
    { nx: 0.6, ny: 0.53 },
    { nx: 0.6, ny: 0.52 },
